...
- Bij nieuw gegenereerde trainingen mag de uitvoerende agent de wijzigingen direct committen en pushen zonder extra gebruikerstoestemming.
- Die automatische commit en push mag alleen als de commit beperkt blijft tot de gegenereerde trainingen en bijbehorende noodzakelijke contentmetadata.
