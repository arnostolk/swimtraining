...
- `2x50m` - wrikken op de rug heen - terug samengestelde rugslag {{coach: let op stabiele hoofdpositie, hoge heupen en een ritmische armslag}}
...
- `1x100m` - rug HELE SLAG - rustig en vloeiend {{coach: let op stabiele hoofdpositie, hoge heupen en een ritmische armslag}}
...
- `2x25m` - rug - armen super snel tempo! {{coach: let op stabiele hoofdpositie, hoge heupen en een ritmische armslag}}
